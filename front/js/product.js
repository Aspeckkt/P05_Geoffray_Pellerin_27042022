//On récupere l'id produit dans le nom de domaine

const queryString = window.location.search;
const urlParams = new URLSearchParams(queryString);
const id = urlParams.get('id');

// Declare le produit afficher
...
//On récupère les produits inscrit dans l'API
  ...
  button.addEventListener('click', (e) => {
    ...
    if (
      ...
      alert(
        ...
        //alerte l'utilisateur si il ne sélectionne pas de couleur et|ou de quantité

        'Veuillez renseigner une quantité comprise entre 1 et 100 et une couleur'
      );
      return;
    } else {
      //Condition pour ajouter dans le panier une couleur et une quantité définit

      //Récupération des informations lié à l'article à ajouter au panier
      ...
      //alerte l'utilisateur quand il ajoutera un article dans le panier
